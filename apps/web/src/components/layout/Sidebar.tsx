...
const BASE_NAV: { id: NavItem; label: string; path: string; icon: React.ReactNode }[] = [
...
export const Sidebar = memo(function Sidebar({ activeItem }: { activeItem?: NavItem }) {
  ...
  const NAV = [
    ...BASE_NAV,
    ...(userRole === 'super_admin' ? [{ id: 'users' as NavItem, label: 'Users', path: '/users', icon: <UsersIcon /> }] : []),
...
function UsersIcon()   { return <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>; }
